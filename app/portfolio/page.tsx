...
function PortfolioPage() {
  ...
  return (
    <>
      <Head>
        <title>Portfólio | Woota Studio</title>
        <meta name="description" content="Conheça o portfólio da Woota Studio: projetos de design, websites, social media e mídia para marcas inovadoras." />
        <meta property="og:title" content="Portfólio | Woota Studio" />
        <meta property="og:description" content="Conheça o portfólio da Woota Studio: projetos de design, websites, social media e mídia para marcas inovadoras." />
        <meta property="og:image" content="/portfolio/og-image.png" />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://woota.studio/portfolio" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Portfólio | Woota Studio" />
        <meta name="twitter:description" content="Conheça o portfólio da Woota Studio: projetos de design, websites, social media e mídia para marcas inovadoras." />
        <meta name="twitter:image" content="/portfolio/og-image.png" />
      </Head>
      <div className="min-h-screen bg-black text-white pb-20">
        ...
        {/* Footer */}
        <footer className="py-16 px-6 border-t border-white/10 mt-24">
